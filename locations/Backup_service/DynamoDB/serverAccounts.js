...
function checkUserStatus(
  ...
  if (
    ...
    dynamoClient.query(
      { ...checkUser, ...{ TableName: "passengers_profiles" } },
    ...
    //2. Drivers
    dynamoClient.query(
      { ...checkUser, ...{ TableName: "drivers_profiles" } },
      function (error, result) {
        if (error) {
          resolve({ response: "error_checking_user" });
        }
          ...
          (result) => {
            ...
            if (
              ...
              new Promise((res2) => {
                let secretData = {
                  UpdateExpression:
                    "set account_verifications.phone_verification_secrets =:verification_secrets",
                  ExpressionAttributeValues: {
                  ...
                  dynamoClient.update(
                    {
                      ...
                      ...{
                        TableName: "passengers_profiles",
                        Key: { user_fingerprint: result.user_fp },
                        ReturnValues: "UPDATED_NEW",
                      },
                    },
                    function (err, reslt) {
                  ...
                  dynamoClient.update(
                    {
                      ...
                      ...{
                        TableName: "drivers_profiles",
                        Key: { driver_fingerprint: result.user_fp },
                        ReturnValues: "UPDATED_NEW",
                      },
                    },
                    function (err, reslt) {
